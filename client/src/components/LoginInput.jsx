...
const LoginInput = ({placeholder, icon, inputState, inputStateFunc, type, isSignUp}) => {
  ...
  return (
    <motion.div {...fadeInOut} className={`flex items-center justify-center gap-4 bg-lightOverlay backdrop-blur-md rounded-md w-full px-4 py-2 ${isFocus ? "shadow-md shadow-red-400" : "none"}`}>
        {icon}
        <input 
            type={type} 
